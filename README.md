# Delivery-Operation-Dashboard-via-Excel
...
Dataset: 750 orders | 6 cities | 30 riders | 4 vehicle types | 3 months data

DASHBOARD COMPONENTS
1. Dashboard Sheet - Executive View
   • 4 KPI Cards: Total Orders, Revenue, Avg Time, Cancellation Rate
   • 6 Charts covering all key operational metrics

2. Analysis Sheet - Detailed Breakdowns
   • City-wise, Vehicle-wise, Rider-wise, Payment analytics

3. Raw_Data Sheet - 750 Records
...
• Rider Productivity → Performance tracking
• Payment Distribution → Cash flow planning
